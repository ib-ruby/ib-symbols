...
RSpec.describe 'Request Market Data for Options', :if => :us_trading_hours,
  ...
  before(:all) do
    ...
    @req = ib.send_message :RequestMarketData, :contract => IB::Symbols::Options.aapl
  ...
  context IB::Messages::Incoming::TickOption do
    subject { IB::Connection.current.received[:TickOption].last }
  ...
  context IB::Messages::Incoming::TickString  do
    subject { IB::Connection.current.received[:TickString].last }
